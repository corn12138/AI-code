...
export const ChatHeader: React.FC<ChatHeaderProps> = ({
  ...
  return (
    <div className="p-4 border-b border-cosmic-500/20 bg-space-900/80 backdrop-blur-xl">
      <div className="flex items-center justify-between">
        {/* Left side - Logo and status */}
        <div className="flex items-center space-x-3">
          <motion.div
            className="w-8 h-8 bg-gradient-to-r from-cosmic-500 to-nebula-600 rounded-full flex items-center justify-center shadow-cosmic"
          ...
          <div>
            <h3 className="font-semibold text-space-200">
              AI Assistant
            </h3>
            <div className="flex items-center space-x-3 text-xs">
              ...
              {/* Current Model */}
              <div className="flex items-center space-x-1">
                <CpuChipIcon className="w-3 h-3 text-space-400" />
                <span className="text-space-400">
        ...
        {showMetrics && (
          <motion.div
            className="hidden md:flex items-center space-x-4 text-xs text-space-400"
      ...
      {state.error && (
        <motion.div
          ...
          className="mt-3 p-2 bg-red-900/40 backdrop-blur-sm border border-red-500/20 rounded-xl"
        >
          <div className="flex items-center justify-between">
