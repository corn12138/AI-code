    ...
    theme: {
        ...
        extend: {
            ...
            keyframes: {
                ...
                "glow": {
                    "0%": { boxShadow: "0 0 5px #6366ff, 0 0 10px #6366ff, 0 0 15px #6366ff" },
                    "100%": { boxShadow: "0 0 10px #6366ff, 0 0 20px #6366ff, 0 0 30px #6366ff" },
                },
                "shimmer": {
            ...
            boxShadow: {
                ...
                'space-glow': '0 0 40px rgba(15, 23, 42, 0.8)',
            },
        },
    },
    plugins: [
